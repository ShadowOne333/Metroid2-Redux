...
ds 1 ; $C3D2 - LCD interrupt handler background palette. Palette is not written if zero
...
tempMetatile:
.topLeft:          ds 1 ; $D000: Metatile top-left
.topLeftColor:     ds 1
.topRight:         ds 1 ; $D002: Metatile top-right
.topRightColor:    ds 1
.bottomLeft:       ds 1 ; $D004: Metatile bottom-left
.bottomLeftColor:  ds 1
.bottomRight:      ds 1 ; $D006: Metatile bottom-right
.bottomRightColor: ds 1
...
ds 1 ; $D07E - BG palette
ds 1 ; $D07F - Object 0 palette
ds 1 ; $D080 - Object 1 palette
...
section "WRAM GBC Buffers", wramx[$d100]
colorBuffer: ds $80 ; $D100..7F - holds data of colors to be loaded to gbc's color ram
rawColorBuffer: ds $80 ; $D180..FF - colors are first loaded here, then copied to colorBuffer to be darkened
def queenRawColorFour = rawColorBuffer + $0040 ; $D1C0 - queen loads a new color 4 at this address

colorIDBuffer: ds $180 ; $D200..$D37F - contains color id of all tiles currently in vram
vramTransferDataBuffer: ds $40 ; $D380..BF - 10:41f1
vramTransferColorIDBuffer: ds $40 ; $D3C0..FF - 10:41f1

section "WRAM GBC", wramx[$d420]
queen_transferColorIDBuffer: ds $20 ; $D420..3F
drawSamusSpriteTileOffset:: ds 1 ; when samus is drawn, this is used to offset tile id to the right buffer for the sprites
samusVRAMBuffer:: ds 1 ; 00 == first buffer, 01 == second buffer
samus_onTheFlyGfx_indexOld:: ds 1 ; set of samus's tiles that is loaded
samus_onTheFlyGfx_indexNew:: ds 1 ; set of samus's tiles that should be loaded
samus_onTheFlyGfx_bufferSize:: ds 1 ; quantity of loaded tiles
gameModeOld: ds 1 ; $D445 - set to gameMode
...
queen_transferHeadColorIDDest: ds 1 ; $D44F - used when coloring the head when it changes
ds 3
queen_transferHeadColorIDFlag: ds 1 ; $D453 - $00 == no transfer, $12 == head transfer 
credits_scrollYSubpixels: ds 1 ; $D454


section "WRAM GfxInfoBuffer", wramx[$d500]
samus_gfxInfoBuffer: ds $D0

section "WRAM Tiletable color", wramx[$d600]
tiletableColorArray:: ds $200 ;$DA00..DBFF: Metatile definitions
.end::
...
; Implicitly bank 10
saveBuf_colorSrcLow:  ds 1 ; $D80F: Tile properties source address (low byte)
saveBuf_colorSrcHigh: ds 1 ; $D810: Tile properties source address (high byte)
...
;}
def saveBufferLength = @ - saveBuffer
...
wramUnused_DD60: ds $DE00 - @ ;$DD60..FF: Unused
...
;    + 2: Top-left tile
;      + 3: Top-left tile color id
;    + 4: Top-right tile
;      + 5: Top-right tile color id
;    + 6: Bottom-left tile
;      + 7: Bottom-left tile color id
;    + 8: Bottom-right tile
;      + 9: Bottom-right tile color id
;}
