...
INCLUDE "sgb/settings.asm"

; ---------------- HEADER ----------------
; This section is handled in bank_000.asm
...
SECTION "ROM - Bank 0 free space", ROM0[bank0_freespace]	; ROM0[BANK0_FREE_SPACE]
boot_hook:
	push	af
...
INCBIN "sgb/sgb_border_map.bin", 0, 32*28*2	;rows 0-27
