...
.hurt:
    ...
    ld a, $08
    ld [queen_flashTimer], a
    ; Exit if the timer was non-zero
        ret nz
    ; Set palette
    xor a
    ld [screenFlashGBC], a
...
queen_drawFeet: ;{
	...
	; IMPROVEMENT PATCH
    ; If the game is paused, prevent the Queen's feet from animating
    ldh a, [gameMode]
    cp $08
        ret z
...
queen_drawProjectiles:
    ld hl, $c308
    ld de, enemyDataSlots.slot_A
    ld b, $03
...
queen_closeFloor:
    ...
    ; assumes hl is back to its initial address
    ld de, .tiles
    ld a, [de]
    ld [hl+], a
    inc de
...
VBlank_drawQueen:
    ...
    call queen_transferHeadColorID
...
queen_transferHeadColorID: ;{
    ld a, [queen_transferHeadColorIDFlag]
    and a
    ret z

    ld de, queen_transferColorIDBuffer
    ld a, [queen_transferHeadColorIDDest]
    ld h, HIGH(_SCRN1)
    ld l, a
    ld c, $03 ; 3 rows
    ...
    .loop:
        ...
        dec c
    jr nz, .loop ; exit when all 3 rows are transferred
